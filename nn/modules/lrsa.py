...
class LRSA(nn.Module):
    ...
    def __init__(self, dim, qk_dim, mlp_dim, heads=4):
        print(f"LRSA init with dim={dim}, qk_dim={qk_dim}, mlp_dim={mlp_dim}, heads={heads}")
        super().__init__()
    ...
    def forward(self, x, ps=16):
        print(f"Running LRSA with input shape: {x.shape}")
        step = ps - 2
